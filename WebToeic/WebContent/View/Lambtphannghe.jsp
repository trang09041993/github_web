...
<title>Câu hỏi bài tập theo mã</title>
    ...
    <!-- font -->
    <link rel="stylesheet" href="Template/FrontendAdmmin/font/font-awesome.min.css" />
    ...
    <script src="Template/FrontendAdmin/js/bootstrap.min.js"></script>
    	...
    	<script type="text/javascript">
					...
					function Xuatketqua()
					{
						...
						var url = "Lambtnghe?kq="+kq+"&num="+<%=request.getAttribute("numberpage")%>+"&listenexercisename="+<%=request.getAttribute("'listenexercisename'")%>;
						
						<%-- var url = "Lambtnghe?kq="+kq+"&listenexercisename="+<%=request.getAttribute("'listenexercisename'")%>; --%>
