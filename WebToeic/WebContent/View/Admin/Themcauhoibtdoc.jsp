								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="Themcauhoibtdoc?readexeriseid=<%=request.getAttribute("readexeriseid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msgthemcauhoibtdoc")!=null?request.getAttribute("msgthemcauhoibtdoc"):" "%>
													</label>
