									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												...
												Thêm ảnh cho bài tập đọc
											</h4>

											<div class="space-6"></div>

											<form action="Themhinhbtdoc?readexeriseid=<%=request.getAttribute("readexeriseid")%>" method="POST" enctype="multipart/form-data">
												<fieldset>
													<label class="block clearfix">
														<%=request.getAttribute("msgthemhinhbtdoc")!=null?request.getAttribute("msgthemhinhbtdoc"):" "%>
													</label>
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-70 pull-right btn btn-sm btn-primary">
															...
															<span class="bigger-110">Thêm ảnh bài tập đọc</span>
														</button>
